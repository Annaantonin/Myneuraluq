...
class Optimizer:
    ...
    def make_train_op(self, loss_fn, losses_fn, trainable_variables, global_step=None):
        ...
        self.loss_op, self.train_op, self.losses = loss_op, train_op, losses
    ...
    def train(self, num_iterations, sess=None, display_every=100):
        ...
        for it in range(num_iterations):
            ...
            if it % display_every == 0:
                print("Iteration: ", it, ", loss: ", sess.run(self.loss_op), "; losses and regularization:", sess.run(self.losses))
