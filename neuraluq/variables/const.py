...
class Trainable(_Trainable):
    ...
    def __init__(
        ...
        # self.value=tf.clip_by_value(init, min_val, max_val)
    ...
    #     """Applies constraints to the trainable variables if any."""
    #     if self.constraint is not None:
    #         # Apply the constraint to each trainable variable
    #         self.value.assign(self.constraint(self.value))
